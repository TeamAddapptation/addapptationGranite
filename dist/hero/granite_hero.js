function granite_hero(jsonHero, jsonTheme) {
  ...
  function heroBkg(o) {
    return o.background_image ? `background: url(${o.background_image}) ${o.align_background_image}; background-size: cover;` : o.background_color ? `background: ${o.background_color};` : "background:transparent";
  }
  ...
  function btnStyle(o) {
    return o.button_style === "transparentWhite" ? "g__cta_button_transparent_white" : o.button_style === "transparentPink" ? "g__cta_button_transparent_pink" : o.button_style === "pink" ? "g__cta_button_color" : "g__cta_button_white";
  }
