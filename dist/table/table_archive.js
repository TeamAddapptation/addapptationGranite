...
(function (root, factory) {
  ...
  function cellFormat(record) {
    ...
    switch (record['type']) {
      ...
      case 'date':
        ...
        var editable = record['editable'] === true ? `<i class="far fa-calendar-alt a__calendar_btn"></i>` : ""; // cell = `${hidden}<input class="a__inline_input" id='${id}' type="text" value="${date}">${editable}`;
  ...
  proto.render = function (type) {
    ...
    var button_container = createElement("div", {
      class: "a__button_container mr-2"
    });
