...
let formsBlock_disable = {
  ...
  "records":[
     ...
     {
        "type":"description",
        "value":"\u003cp\u003eCreating a form in addapptation is designed to be easy but extremely flexible. Forms are built with a combination of standard form elements, as well as inline rows and sections.\u003c/p\u003e",
        "font_size":"20px",
        "dependency_field":"",
        "dependency_values":"",
        "addapptation_component":true,
     ...
     },
     {
        ...
        "value":"",
        "options":[
           ["Hamburger", "Hamburger"], ["Pizza", "Pizza"], ["Hot Dog", "Hot Dog"],
        ],
        "placeholder":"",
        "autocomplete":"on",
        "length":"0",
...
let formsBlock_signup = {
   "id":"granite-form",
   "options":{submit_label: 'submit', autosave: false, title: 'addapptation Visual Builder', description: 'test', form_id: 'a__340790a736b8aa8b57a6', action: '/sign_in', auto_superscript: 'true', method: 'POST', enctype: 'application/x-www-form-urlencoded'},
   "records":[
      {
         "type":"email",
...
let formsBlock = {
   ...
   "records":[
      ...
      },
      {
         ...
         "addapptation_type":"custom_field",
         "addapptation_code_id":"a0R1I00000J7p9iUAB",
         "addapptation_id":"0820300971983903",
         "addapptation_navigation":"",
         "required":false,
         "inline":false,
         "use_options_from_database":false,
      ...
      },
      {
         ...
         "addapptation_type":"custom_field",
         "addapptation_code_id":"a0R1I00000J7p9iUAB",
         "addapptation_id":"08204223263038675",
         "addapptation_navigation":"",
         "required":false,
         "inline":false,
         "use_options_from_database":false,
...
let textBlock = {
  ...
  "options":{
    ...
    "text": "<h1>This is a header</h1><p>This is some body copy</p><a href='#'>Link</a>",
    "padding": "100px",
    "margin": "50px"
  }
}
...
let tableBlock = {
   ...
   "options": {
       ...
       button_1_label: "Button 1",
       button_1_href: "/datatables_dev_temp?selection=button1",
       button_1_sidepane: "true",
       button_2_label: "Button 2",
       button_2_href: "/datatables_dev_temp?selection=button2",
       button_2_sidepane: "true",
       button_3_label: "Button 3",
       button_3_href: "/datatables_dev_temp?selection=button3",
       button_3_sidepane: "true",
       button_4_label: "Button 4",
       button_4_href: "/datatables_dev_temp?selection=button4",
       button_4_sidepane: "false",
       button_5_label: "Button 5",
       button_5_href: "/datatables_dev_temp?selection=button5",
       button_5_sidepane: "true",

       filter_1_label: "Filter1",
       filter_1_options: ["option 1","option 2","option 3","option 4","option 5"],
       filter_1_name: "filter1",
       filter_2_label: "Filter2",
       filter_2_options: ["option 1","option 2","option 3","option 4","option 5"],
       filter_2_name: "filter2",
       filter_3_label: "",
       filter_3_options: [],
       filter_3_name: "",
       filter_4_label: "",
   ...
   "records":[
       {"columns": ["Name", "Birthday", "Department", "Manager", "Years", "Salary", "Admin", "Link", "Link", "Delete"]},
       [
       {"max_width": "150px", "id": "a__001", "object": "Account", "type": "link", "href": "/button", "target": "", "name": "Name__c", "value": "Michael James", "editable": true, "editable_shown": false},
       {"max_width": "150px", "id": "a__132", "object": "Account", "type": "date", "name": "Birthday__c", "value": "1987-01-19", "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__003", "object": "Account", "type": "string", "name": "Department__c", "value": "Development", "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__003", "object": "Account", "type": "picklist", "name": "manager__c", "value": "Calla Brown", "options": ["Sarah Redman","Philip Brady", "Calla Brown", "Vic Silverman"], "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__004", "object": "Account", "type": "number", "name": "years__c", "value": 8, "editable": false, "editable_shown": false},
       {"max_width": "150px", "id": "a__005", "object": "Account", "type": "currency", "name": "salary__c", "value": 89000, "editable": false, "editable_shown": false},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "checkbox", "name": "admin__c", "checked": true, "editable": false, "editable_shown": true},
       {"max_width": "150px", "id": "a__007", "object": "Account", "type": "link", "href": "https://addapptation.com/", "target": "_blank", "name": "link__c", "value": "Tab Link"},
       {"max_width": "150px", "id": "a__008", "object": "Account", "type": "link", "href": "https://addapptation.com/", "target": "", "side_pane": true, "name": "link__c", "value": "Side Link"},
       {"max_width": "150px", "id": "a__009", "object": "Account", "type": "delete"}
       ],
       [
       {"max_width": "150px", "id": "a__001", "object": "Account", "type": "link", "href": "/button", "target": "", "name": "Name__c", "value": "Caitlin Black", "editable": true, "editable_shown": false},
       {"max_width": "150px", "id": "a__542", "object": "Account", "type": "date", "name": "Birthday__c", "value": "1992-07-09", "editable": false, "editable_shown": true},
       {"max_width": "150px", "id": "a__003", "object": "Account", "type": "string", "name": "Department__c", "value": "HR", "editable": false, "editable_shown": false},
       {"max_width": "150px", "id": "a__003", "object": "Account", "type": "picklist", "name": "manager__c", "value": "Sarah Redman", "options": ["Sarah Redman","Philip Brady", "Calla Brown", "Vic Silverman"], "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__004", "object": "Account", "type": "number", "name": "years__c", "value": 2, "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__005", "object": "Account", "type": "currency", "name": "salary__c", "value": 60000, "editable": false, "editable_shown": false},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "checkbox", "name": "admin__c", "checked": false, "editable": false, "editable_shown": true},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "link", "href": "https://addapptation.com/", "target": "_blank", "name": "link__c", "value": "Tab Link"},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "link", "href": "https://addapptation.com/", "target": "", "side_pane": true, "name": "link__c", "value": "Side Link"},
       {"max_width": "150px", "id": "a__009", "object": "Account", "type": "delete"}
       ],
       [
       {"max_width": "150px", "id": "a__001", "object": "Account", "type": "link", "href": "/button", "target": "", "name": "Name__c", "value": "Jeff Chester", "editable": true, "editable_shown": false},
       {"max_width": "150px", "id": "a__842", "object": "Account", "type": "date", "name": "Birthday__c", "value": "1995-07-09", "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__003", "object": "Account", "type": "string", "name": "Department__c", "value": "This is a really long string for testing", "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__003", "object": "Account", "type": "picklist", "name": "manager__c", "value": "Calla Brown", "options": ["Sarah Redman","Philip Brady", "Calla Brown", "Vic Silverman"], "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__004", "object": "Account", "type": "number", "name": "years__c", "value": 1, "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__005", "object": "Account", "type": "currency", "name": "salary__c", "value": 67000, "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "checkbox", "name": "admin__c", "checked": false, "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "link", "href": "https://addapptation.com/", "target": "_blank", "name": "link__c", "value": "Tab Link"},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "link", "href": "https://addapptation.com/", "target": "", "side_pane": true, "name": "link__c", "value": "Side Link"},
       {"max_width": "150px", "id": "a__009", "object": "Account", "type": "delete"}
       ],
       [
       {"max_width": "150px", "id": "a__001", "object": "Account", "type": "link", "href": "/button", "target": "", "name": "Name__c", "value": "Cash Averil", "editable": true, "editable_shown": false},
       {"max_width": "150px", "id": "a__652", "object": "Account", "type": "date", "name": "Birthday__c", "value": "1987-09-19", "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__003", "object": "Account", "type": "string", "name": "Department__c", "value": "Accounting", "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__003", "object": "Account", "type": "picklist", "name": "manager__c", "value": "Calla Brown", "options": ["Sarah Redman","Philip Brady", "Calla Brown", "Vic Silverman"], "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__004", "object": "Account", "type": "number", "name": "years__c", "value": 13, "editable": false, "editable_shown": false},
       {"max_width": "150px", "id": "a__005", "object": "Account", "type": "currency", "name": "salary__c", "value": 120000, "editable": false, "editable_shown": false},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "checkbox", "name": "admin__c", "checked": true, "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "link", "href": "https://addapptation.com/", "target": "_blank", "name": "link__c", "value": "Tab Link"},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "link", "href": "https://addapptation.com/", "target": "", "side_pane": true, "name": "link__c", "value": "Side Link"},
       {"max_width": "150px", "id": "a__009", "object": "Account", "type": "delete"}
       ],
       [
       {"max_width": "150px", "id": "a__001", "object": "Account", "type": "link", "href": "/button", "target": "", "name": "Name__c", "value": "Collette Maddock", "editable": true, "editable_shown": false},
       {"max_width": "150px", "id": "a__362", "object": "Account", "type": "date", "name": "Birthday__c", "value": "1990-12-21", "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__003", "object": "Account", "type": "string", "name": "Department__c", "value": "Finance", "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__003", "object": "Account", "type": "picklist", "name": "manager__c", "value": "Calla Brown", "options": ["Sarah Redman","Philip Brady", "Calla Brown", "Vic Silverman"], "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__004", "object": "Account", "type": "number", "name": "years__c", "value": 1, "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__005", "object": "Account", "type": "currency", "name": "salary__c", "value": 145000, "editable": false, "editable_shown": false},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "checkbox", "name": "admin__c", "checked": true, "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "link", "href": "https://addapptation.com/", "target": "_blank", "name": "link__c", "value": "Tab Link"},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "link", "href": "https://addapptation.com/", "target": "", "side_pane": true, "name": "link__c", "value": "Side Link"},
       {"max_width": "150px", "id": "a__009", "object": "Account", "type": "delete"}
       ...
       [
       {"max_width": "150px", "id": "a__001", "object": "Account", "type": "link", "href": "/button", "target": "", "name": "Name__c", "value": "Django Hernandes", "editable": true, "editable_shown": false},
       {"max_width": "150px", "id": "a__152", "object": "Account", "type": "date", "name": "Birthday__c", "value": "1990-02-12", "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__003", "object": "Account", "type": "string", "name": "Department__c", "value": "Development", "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__003", "object": "Account", "type": "picklist", "name": "manager__c", "value": "Calla Brown", "options": ["Sarah Redman","Philip Brady", "Calla Brown", "Vic Silverman"], "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__004", "object": "Account", "type": "number", "name": "years__c", "value": 1, "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__005", "object": "Account", "type": "currency", "name": "salary__c", "value": 60000, "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "checkbox", "name": "admin__c", "value": false, "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "link", "href": "https://addapptation.com/", "target": "_blank", "name": "link__c", "value": "Tab Link"},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "link", "href": "https://addapptation.com/", "target": "", "side_pane": true, "name": "link__c", "value": "Side Link"},
       {"max_width": "150px", "id": "a__009", "object": "Account", "type": "delete"}
       ],
       [
       {"max_width": "150px", "id": "a__001", "object": "Account", "type": "link", "href": "/button", "target": "", "name": "Name__c", "value": "Caitlin Black", "editable": true, "editable_shown": false},
       {"max_width": "150px", "id": "a__892", "object": "Account", "type": "date", "name": "Birthday__c", "value": "2020-07-09", "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__003", "object": "Account", "type": "string", "name": "Department__c", "value": "HR", "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__003", "object": "Account", "type": "picklist", "name": "manager__c", "value": "Calla Brown", "options": ["Sarah Redman","Philip Brady", "Calla Brown", "Vic Silverman"], "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__004", "object": "Account", "type": "number", "name": "years__c", "value": 1, "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__005", "object": "Account", "type": "currency", "name": "salary__c", "value": 60000, "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "checkbox", "name": "admin__c", "value": false, "editable": true, "editable_shown": true},
       ...
       [
       {"max_width": "150px", "id": "a__001", "object": "Account", "type": "link", "href": "/button", "target": "", "name": "Name__c", "value": "Meghan Wright", "editable": true, "editable_shown": false},
       {"max_width": "150px", "id": "a__322", "object": "Account", "type": "date", "name": "Birthday__c", "value": "2020-07-09", "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__003", "object": "Account", "type": "string", "name": "Department__c", "value": "HR", "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__003", "object": "Account", "type": "picklist", "name": "manager__c", "value": "Calla Brown", "options": ["Sarah Redman","Philip Brady", "Calla Brown", "Vic Silverman"], "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__004", "object": "Account", "type": "number", "name": "years__c", "value": 4, "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__005", "object": "Account", "type": "currency", "name": "salary__c", "value": 70000, "editable": false, "editable_shown": false},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "checkbox", "name": "admin__c", "value": false, "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "link", "href": "https://addapptation.com/", "target": "_blank", "name": "link__c", "value": "Tab Link"},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "link", "href": "https://addapptation.com/", "target": "", "side_pane": true, "name": "link__c", "value": "Side Link"},
       {"max_width": "150px", "id": "a__009", "object": "Account", "type": "delete"}
       ...
       [
       {"max_width": "150px", "id": "a__001", "object": "Account", "type": "link", "href": "/button", "target": "", "name": "Name__c", "value": "Alex Bourassa", "editable": true, "editable_shown": false},
       {"max_width": "150px", "id": "a__002", "object": "Account", "type": "date", "name": "Birthday__c", "value": "2020-07-09", "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__003", "object": "Account", "type": "string", "name": "Department__c", "value": "HR", "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__003", "object": "Account", "type": "picklist", "name": "manager__c", "value": "Calla Brown", "options": ["Sarah Redman","Philip Brady", "Calla Brown", "Vic Silverman"], "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__004", "object": "Account", "type": "number", "name": "years__c", "value": 6, "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__005", "object": "Account", "type": "currency", "name": "salary__c", "value": 66000, "editable": false, "editable_shown": false},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "checkbox", "name": "admin__c", "value": false, "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "link", "href": "https://addapptation.com/", "target": "_blank", "name": "link__c", "value": "Tab Link"},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "link", "href": "https://addapptation.com/", "target": "", "side_pane": true, "name": "link__c", "value": "Side Link"},
       {"max_width": "150px", "id": "a__009", "object": "Account", "type": "delete"}
       ...
       [
       {"max_width": "150px", "id": "a__001", "object": "Account", "type": "link", "href": "/button", "target": "", "name": "Name__c", "value": "Sam Therrien", "editable": true, "editable_shown": false},
       {"max_width": "150px", "id": "a__012", "object": "Account", "type": "date", "name": "Birthday__c", "value": "2020-07-09", "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__003", "object": "Account", "type": "string", "name": "Department__c", "value": "HR", "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__003", "object": "Account", "type": "picklist", "name": "manager__c", "value": "Calla Brown", "options": ["Sarah Redman","Philip Brady", "Calla Brown", "Vic Silverman"], "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__004", "object": "Account", "type": "number", "name": "years__c", "value": 5, "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__005", "object": "Account", "type": "currency", "name": "salary__c", "value": 78000, "editable": false, "editable_shown": false},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "checkbox", "name": "admin__c", "value": false, "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "link", "href": "https://addapptation.com/", "target": "_blank", "name": "link__c", "value": "Tab Link"},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "link", "href": "https://addapptation.com/", "target": "", "side_pane": true, "name": "link__c", "value": "Side Link"},
       {"max_width": "150px", "id": "a__009", "object": "Account", "type": "delete"}
       ...
       [
       {"max_width": "150px", "id": "a__001", "object": "Account", "type": "link", "href": "/button", "target": "", "name": "Name__c", "value": "Heather Robinson", "editable": true, "editable_shown": false},
       {"max_width": "150px", "id": "a__005", "object": "Account", "type": "date", "name": "Birthday__c", "value": "1980-11-03", "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__003", "object": "Account", "type": "string", "name": "Department__c", "value": "Accounting", "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__003", "object": "Account", "type": "picklist", "name": "manager__c", "value": "Calla Brown", "options": ["Sarah Redman","Philip Brady", "Calla Brown", "Vic Silverman"], "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__004", "object": "Account", "type": "number", "name": "years__c", "value": 21, "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__005", "object": "Account", "type": "currency", "name": "salary__c", "value": 100000, "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "checkbox", "name": "admin__c", "value": false, "editable": true, "editable_shown": true},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "link", "href": "https://addapptation.com/", "target": "_blank", "name": "link__c", "value": "Tab Link"},
       {"max_width": "150px", "id": "a__006", "object": "Account", "type": "link", "href": "https://addapptation.com/", "target": "", "side_pane": true, "name": "link__c", "value": "Side Link"},
       {"max_width": "150px", "id": "a__009", "object": "Account", "type": "delete"}
