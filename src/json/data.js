...
let formsBlock = {
  ...
  "options":{
     "title":"",
     "addapptation_action":"/query_builder?tab=2",
     "description":"Enter the name of the object to start building your query",
     ...
     "db_id":"g__3827ds92",
     "db_redirect":"",
     "flash_message":"", // confirmatin message
     "form_id":"a__458n23ru",
     "button_1_label":"",
     "button_1_href":"",
     "submit_label":"Submit",
  ...
  "records":[
     {
        ...
        "required":true,
        "options":[
           ["AAKCS__AAkonsult_Settings__mdt-AAkonsult Setting", "AAkonsult Setting"],
           ["AAKCS__AAkonsult_Setting", "Option 2"],
           ["AAKCS", "Option 3"]
        ],
        "placeholder":"",
        "autocomplete":"on",
