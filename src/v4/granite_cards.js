...
function granite_cards(jsonBlock, jsonTheme) {
  /*---------------------------------------------
    ...
    !!o.g_card_background ? o.g_card_background : cardBkgMode;
    ...
    r.forEach((r, count) => {
      ...
      if(String(o.g_description_preview) === "true" && String(o.g_display_list) != "true"){
        ...
        cardWrap = document.createElement('div');
          ...
          if(!!r.g_btn_text){
            ...
            btn.classList.add('g__card_btn');
            btn.href = r.g_href || "#";
            r.g_new_window === "true" ? btn.target = "_blank" : btn.target = "_self";
            btn.innerHTML = r.g_btn_text;
