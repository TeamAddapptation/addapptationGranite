"use strict";
function granite_form_step(formsBlock, jsonTheme) {
  ...
  let formStyles = graniteDocument.createElement("style");
  ...
  ${cssId} .g__step_btns{
    ...
    padding: 15px 0;
    margin-top: 15px;
    border-top: 1px solid ${fieldBkgColor};
  }
...
${cssId} .g__check_container [type="checkbox"]:disabled + label {
  ...
  graniteDocument.head.appendChild(formStyles);
  /* -------------------- Regex Expressions ----------------------*/
  const patterns = {
  ...
  //   const form_action_row = graniteDocument.createElement("div");
  //   form_action_row.setAttribute("class", "g__form_action_row");

  //   if (!!o.title) {
  //     const form_title = graniteDocument.createElement("h2");
  ...
  //   if (!!o.description) {
  //     const form_description = graniteDocument.createElement("p");
  ...
  //   }
  //   graniteDocument.getElementById(granite_id).appendChild(form_action_row);
  // }

  /* -------------------- Form Container ----------------------*/
  let form_container = graniteDocument.createElement("form");
  ...
  if(r[0].children){
    ...
    if (totalRecords === 1 && children === 0){
      let empty = graniteDocument.createElement("div");
      ...
      /*---------------------------------------------
      Run extensions even is records are empty
      ---------------------------------------------*/
  ...
  function addLabels(field_info_container, r) {
    ...
    if (!!r.title) {
      let label = graniteDocument.createElement("label");
    ...
    if (r.length > 0 && r.show_count) {
      let count_container = graniteDocument.createElement("div");
    ...
    if (r.g_type === "spacing") {
      let field_options = graniteDocument.createElement("div");
  ...
  /* -------------------- Step ----------------------*/
  let indicator = graniteDocument.createElement('div');
    ...
    function parseRecord(r) {
      ...
      r.forEach(function (r, num) {
        switch (r.g_type) {
          case 'pane_start':
          case 'section':
              let form_section_container = graniteDocument.createElement("div");
              ...
              let section_header = graniteDocument.createElement("div");
              ...
              let title = graniteDocument.createElement("div");
                  title.setAttribute("class", "g__section_title");
                  title.innerHTML = r.title || "Section";
              let line = graniteDocument.createElement("div");
                  line.setAttribute("class", "g__section_line");
              let icon = graniteDocument.createElement("div");
              ...
              let form_section = graniteDocument.createElement("div");
          ...
          case 'step':
            ...
            let progress = graniteDocument.createElement('div')
                progress.classList.add('g__progress')
                indicator.appendChild(progress);
            let form_step = graniteDocument.createElement("div");
  ...
  if (isStep && (stepCount > 1)){
    let progressBtns = graniteDocument.createElement('div');
    progressBtns.classList.add('g__step_btns');

    let prev = graniteDocument.createElement('button');
    prev.id = 'g__prev_btn';
    prev.type = "button";
    ...
    let next = graniteDocument.createElement('button');
    next.id = 'g__next_btn';
    next.type = "button";
  ...
  function buildRecord(r, num){
      /* -------------------- Error Field ----------------------*/
      let error_field = graniteDocument.createElement("div");
      ...
      if (
        ...
        form_field = graniteDocument.createElement("div");
        ...
        field_info_container = graniteDocument.createElement("div");
      ...
      switch (r.g_type) {
        case "boolean":
        case "checkbox":
          let check_container = graniteDocument.createElement("div");
          ...
          input = graniteDocument.createElement("input");
          ...
          if (String(r.switch) === "true"){
            let slider = graniteDocument.createElement('span');
        ...
        case "color":
          ...
          let color_container = graniteDocument.createElement("div");
          ...
          var hex_display = graniteDocument.createElement("input");
        ...
        case "currency":
          form_field.appendChild(addLabels(field_info_container, r));
          let curr_container = graniteDocument.createElement("div");
          ...
          let curr_format = graniteDocument.createElement("div");
          ...
          let curr_counter = graniteDocument.createElement("div");
          curr_counter.setAttribute("class", "g__number_plus_minus");
          // Increase container
          let curr_increase = graniteDocument.createElement("div");
          curr_increase.setAttribute("class", "g__number_increase");
          curr_counter.appendChild(curr_increase);
          // Decrease container
          let curr_decrease = graniteDocument.createElement("div");
        ...
        case "date":
          form_field.appendChild(addLabels(field_info_container, r));
          let date_container = graniteDocument.createElement("div");
          ...
          let date_icon = graniteDocument.createElement("div");
        ...
        case "divider":
          ...
          break;
        case "description":
          form_field = graniteDocument.createElement("p");
          form_field.setAttribute('data-micro-id', id);
          !!r.addapptation_id ? form_field.setAttribute('data-record-id', r.addapptation_id) : "";
        ...
        case "file":
          form_field.appendChild(addLabels(field_info_container, r));
          let file_container = graniteDocument.createElement("div");
        ...
        case "multi":
          form_field.appendChild(addLabels(field_info_container, r));
          let multi_container = graniteDocument.createElement("div");
          ...
          let multi_select = graniteDocument.createElement("select");
          ...
          if (multi_double_arr) {
            for (let i = 0; i < multi_options.length; i++) {
              let option = graniteDocument.createElement("option");
        ...
        case "number":
          form_field.appendChild(addLabels(field_info_container, r));
          let num_container = graniteDocument.createElement("div");
          ...
          !!r.pattern ? input.setAttribute("pattern", r.pattern) : "";
          if(!!r.num_unit){
            let unit = graniteDocument.createElement('div');
            unit.classList.add('g__num_unit');
            unit.innerHTML = r.num_unit;
            num_container.appendChild(unit);
          }
          // Increase decrease container
          let num_counter = graniteDocument.createElement("div");
          num_counter.setAttribute("class", "g__number_plus_minus");
          // Increase container
          let num_increase = graniteDocument.createElement("div");
          ...
          // Decrease container
          let num_decrease = graniteDocument.createElement("div");
        ...
        case "password":
          form_field.appendChild(addLabels(field_info_container, r));
          let pass_container = graniteDocument.createElement("div");
          ...
          String(r.required) === "true" ? input.classList.add('g__required') : "";
          !!r.pattern ? input.setAttribute("pattern", r.pattern) : "";
          let pass_show = graniteDocument.createElement("div");
        ...
        case "picklist":
          ...
          input = graniteDocument.createElement("div");
          ...
          let select = graniteDocument.createElement("select");
          ...
          if (String(o.default_picklists) === "true" && r.placeholder) {
            let option_placeholder = graniteDocument.createElement("option");
        ...
        case "radio":
          ...
          let radio_container = graniteDocument.createElement("div");
          radio_container.setAttribute("class", "g__radio_container");
          for (let i = 0; i < radio_options.length; i++) {
            let input_container = graniteDocument.createElement("div");
            input_container.setAttribute("class", "g__radio_option");
            input = graniteDocument.createElement("input");
            input.setAttribute("class", "g__field_radio");
            !!r.name ? input.setAttribute('data-attr', r.name) : "";
            !!attr__form_id ? input.setAttribute("form_id", attr__form_id) : "";
            String(r.next_on_click) === "true" ? input.addEventListener('click', () => { nextPrev(currStep) }) : "" ;
            input.type = "radio";
            input.name = r.name;
            input.required = r.required;
            String(r.required) ? input.classList.add('g__required') : "";
            String(r.disabled) === 'true' ? input.disabled = 'true' : "" ;
            let radio_label = graniteDocument.createElement("label");
            ...
            if (is_double_array){
              ...
              radio_label.setAttribute("for", radio_options[i]);
              radio_label.innerHTML = radio_options[i];
            }
            let radio = graniteDocument.createElement("div");
        ...
        case "range":
          ...
          let range_container = graniteDocument.createElement("div");
          ...
          !!r.name ? input.setAttribute('data-attr', r.name) : "";
          String(r.required) === "true" ? input.classList.add('g__required') : "";
          let output = graniteDocument.createElement("input");
        ...
        case "spacing":
          ...
          const spacing_container = graniteDocument.createElement("div");
          spacing_container.setAttribute("class", "g__spacing_container");
          //Desktop hidden field
          const hidden_desktop = graniteDocument.createElement("input");
          ...
          //mobile hidden field
          const hidden_mobile = graniteDocument.createElement("input");
          ...
          spacing_arr.forEach((val, num) => {
            if (val === "link") {
              let field_container = graniteDocument.createElement("div");
              num === 1
              ...
              let link = graniteDocument.createElement("div");
        ...
        case "header":
        case "subheader":
          form_field = graniteDocument.createElement("h2");
        ...
        case "textarea":
          form_field.appendChild(addLabels(field_info_container, r));
          input = graniteDocument.createElement("textarea");
          input.setAttribute("id", r.id);
          basicAttributes(r, input, class_name);
          String(r.required) === "true" ? input.classList.add('g__required') : "";
        ...
        case "quill":
          form_field.appendChild(addLabels(field_info_container, r));
          let quil = graniteDocument.createElement("div");
      ...
      if(String(r.inline_field) === "true"){
        ...
        arrInline.push(form_field);
        let inlineRow = graniteDocument.createElement("div");
    ...
    if ((!o.hide_submit || o.allow_cancel) && isStep != true) {
      let button_container = graniteDocument.createElement("div");
      button_container.id = "g__submit_cancel";
      button_container.setAttribute("class", "g__button_container");
      // Submit & Cancel Button
      if (!o.hide_submit) {
        let submit = graniteDocument.createElement("button");
      ...
      if (String(o.allow_cancel) === "true") {
        let cancel = graniteDocument.createElement("button");
      ...
      if (!!o.button_1_label) {
        let form_custom_btn = graniteDocument.createElement("a");
    ...
    graniteDocument.getElementById(granite_id).appendChild(form_container);

    /* -------------------- Submit on Enter ----------------------*/
    if(String(o.submit_on_enter) === 'false'){
      graniteDocument.getElementById(granite_id).onkeypress = function(e) {
    ...
    /* -------------------- Submit ----------------------*/
    let form = graniteDocument.getElementById(attr__form_id);
    ...
    function validate(){
      let all_field_containers = graniteDocument.querySelectorAll(".g__form_field");
      let all_sections = graniteDocument.querySelectorAll(
    ...
    /* -------------------- Back Cancel Button ----------------------*/
    if (o.allow_cancel) {
      let cancel = graniteDocument.getElementById("g__cancel_btn");
      if(!!cancel){
    ...
    all_files.forEach((file) => {
      ...
      real_file_field.addEventListener("change", () => {
        if (real_file_field.value) {
          ...
          let file_selected = graniteDocument.createElement("div");
          file_selected.classList.add("g__selected_file");
          let file_delete = graniteDocument.createElement("div");
    ...
    function showTab(n) {
      ...
      if (n == (x.length - 1)) {
        ...
        if(!submitBtn){
          let stepSubmit = graniteDocument.createElement("button");
    ...
    //   x = graniteDocument.getElementsByClassName("g__step");
    ...
    //   if (valid) {
    //     graniteDocument.getElementsByClassName("g__step")[currStep].className += " finish";
    //   }
    //   return valid; // return the valid status
    // }
    function fixStepIndicator(n) {
      // This function removes the "active" class of all steps...
      var i, x = graniteDocument.getElementsByClassName("g__progress");
    ...
    /* -------------------- Spacing Values ----------------------*/
    let spacing_field_arr = graniteDocument.querySelectorAll(".g__spacing_container");
    ...
    if (quil_fields.length) {
      for (let i = 0; i < quil_fields.length; i++) {
        ...
        let quill_elm = graniteDocument.getElementById(quil_fields[i].id);
    ...
    //     let main_container = graniteDocument.createElement("div");
    //     main_container.setAttribute("class", "g__select_main");

    //     let left_container = graniteDocument.createElement("div");
    //     left_container.id = "g__select_home";
    //     left_container.setAttribute("class", "g__drag_parent");

    //     let add_btn = graniteDocument.createElement("button");
    //     add_btn.type = "button";
    ...
    //       const draggableElement = graniteDocument.getElementById(id);
    ...
    //     let right_container = graniteDocument.createElement("div");
    //     right_container.id = "g__select_drop";
    //     right_container.setAttribute("class", "g__drag_parent");

    //     let remove_btn = graniteDocument.createElement("button");
    ...
    //       option_block = graniteDocument.createElement("div");
    ...
    if (String(o.default_picklists) === "false") {
      ...
      f = graniteDocument.getElementById(id);
      ...
      if (x.length > 0) {
        ...
        for (i = 0; i < l; i++) {
          ...
          a = graniteDocument.createElement("div");
          a.setAttribute("class", "g__select_selected");
          a.innerHTML = selElmnt.options[selElmnt.selectedIndex].innerHTML;
          x[i].appendChild(a);
          /* For each element, create a new DIV that will contain the option list: */
          b = graniteDocument.createElement("div");
          b.setAttribute("class", "select-items select-hide");
          search = graniteDocument.createElement("input");
          ...
          for (j = 0; j < ll; j++) {
            ...
            c = graniteDocument.createElement("div");
        ...
        function closeAllSelect(elmnt) {
          ...
          var x,
            ...
            yl,
            arrNo = [];
          x = graniteDocument.getElementsByClassName("select-items");
          y = graniteDocument.getElementsByClassName("g__select_selected");
          xl = x.length;
          yl = y.length;
          for (i = 0; i < yl; i++) {
            if (elmnt == y[i]) {
        ...
        graniteDocument.addEventListener("click", closeAllSelect);
      }
    }

    /* -------------------- Picklist Multi ----------------------*/
    let multiple_field = graniteDocument.getElementsByClassName("g__select_multiple");
    ...
    function start_auto_save(form_id) {
      if (auto_save_count > 0) {
        ...
        auto_save_count = 0;
        graniteDocument.getElementById('save_notice').innerHTML = "Saving..."
      }
      if (auto_save_count == 0) {
    ...
    function save(form_id) {
      const formSave = graniteDocument.getElementById(attr__form_id);
      ...
      $.ajax({
        ...
        .done(function (data) {
          ...
          graniteDocument.getElementById('save_notice').innerHTML = "Saved"
        })
        .fail(function (data) {
          console.debug("autosave failed");
          graniteDocument.getElementById('save_notice').innerHTML = "A problem occurred, please try again."
        });
      return false;
    }
    ...
    if (o.autosave) {
      ...
      let select_arr = [];
      let textarea_arr = [];
      let arr_form_fields = graniteDocument.querySelectorAll(
    ...
    /* -------------------- Show Password ----------------------*/
    let show_password = graniteDocument.querySelectorAll(".g__password_show");
    if (show_password) {
    ...
    function depCheck (r, num) {
      ...
      if (is_dep) {
        let dep_name = graniteDocument.getElementsByName(r.dependency_field);
        let dep_type;
        let dep_parent;
        if(!!dep_name){
          dep_type = dep_name[0].type;
          dep_parent = graniteDocument.getElementById(dep_name[0].id);
        } else {
          console.log('Dependency field name does not exist')
        }
        let dep_child = graniteDocument.getElementById(r.id);
